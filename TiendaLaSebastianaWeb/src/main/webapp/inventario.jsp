    ...
    <body>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (idProducto) {
                    console.log("DEBUG JS: idProducto encontrado en URL:", idProducto);
                    document.getElementById("buscarValor").value = idProducto;
                    document.getElementById("tipoBusqueda").value = "ID";
                    setTimeout(() => {
